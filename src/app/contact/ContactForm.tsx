...
export default function ContactForm() {
  ...
  // ajout de la fonction de soumission vers /api/contact
  ...
  // ajout de l'affichage du message de succès intégré
  if (isSent) {
    return (
      <div className="w-full max-w-3xl rounded-2xl border border-white/8 bg-white/5 backdrop-blur-md p-10 text-center flex flex-col items-center gap-4">
        ...
        <button
          ...
          className="mt-4 text-naruto-orange text-sm font-medium hover:underline"
        >
  ...
  return (
    ...
    >
      ...
      {/* ajout du widget turnstile avec gestion du token */}
      ...
      <div className="flex justify-center">
        <button
          ...
          className="inline-flex items-center gap-2 px-8 py-2.5 rounded-full font-semibold text-sm bg-naruto-orange hover:bg-[#e65500] text-white transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
        >
