...
export default function Pagination({
  ...
  const btnBase =
    "flex items-center justify-center h-9 transition-all duration-150 cursor-pointer text-sm font-semibold";
  const btnNav =
    "w-9 rounded-xl hover:bg-white/10 hover:text-white disabled:opacity-25 disabled:cursor-not-allowed text-white/50";
  const btnPage =
    "w-9 rounded-xl hover:bg-white/10 hover:text-white text-white/50";
  const btnActive =
    "w-9 rounded-xl bg-naruto-orange text-white shadow-md shadow-naruto-orange/30 cursor-default";
